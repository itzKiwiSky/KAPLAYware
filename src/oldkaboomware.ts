...
import type { Color, GameObj, KAPLAYCtx, KAPLAYOpt, KEventController, Key, Vec2 } from "kaplay";
...
export type GameCtx = Pick<KAPLAYCtx, typeof gameAPIs[number]> & GameAPI;
...
export type Opts = {
	 ...
	 */
	dev?: boolean;
	scale?: KAPLAYCtx["scale"];
	letterbox?: KAPLAYCtx["letterbox"];
	background?: KAPLAYCtx["background"];
	canvas?: KAPLAYCtx["canvas"];
	root?: KAPLAYCtx["root"];
	stretch?: KAPLAYCtx["stretch"];
	pixelDensity?: KAPLAYCtx["pixelDensity"];
	crisp?: KAPLAYCtx["crisp"];
	gamepads?: KAPLAYCtx["gamepads"];
	maxFPS?: KAPLAYCtx["maxFPS"];
	focus?: KAPLAYCtx["focus"];
};
